(function () {
  ...
  function injectModal() {
    ...
    style.textContent = [
      ...
      '#' + MODAL_ID + ' .modal-content *{border-radius:inherit;}',
      '#' + DIALOG_ID + '>*{border-radius:0;}',
      '#' + DIALOG_ID + ' .partExchange,#' + DIALOG_ID + ' .partExchange *:not(#' + CLOSE_ID + '){border-radius:0!important;}',
